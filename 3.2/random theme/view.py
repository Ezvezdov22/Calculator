...
#######################
bgcolor1 = random.randrange(0,255)
bgcolor2 = random.randrange(0,255)
bgcolor3 = random.randrange(0,255)
#######################
paintercounter = [0]
t = turtle
t.width(5)
...
t.colormode(255)
s.bgcolor(bgcolor1,bgcolor2,bgcolor3)
...
def clearall():
    t.color(bgcolor1,bgcolor2,bgcolor3)
    t.width(1)
    t.penup()
    t.goto(-156, 84)
    t.begin_fill()
